...
data class CoinDetailsDto(
    ...
    @SerializedName("links_extended") val linksExtended: List<LinksExtendedDto>,
    ...
    @SerializedName("team") val team: List<TeamMemberDto>,
    @SerializedName("type") val type: String,
    @SerializedName("whitepaper") val whitePaper: WhitePaperDto
)